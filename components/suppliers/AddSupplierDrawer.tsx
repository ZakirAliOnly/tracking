...
export function AddSupplierDrawer({ open, onClose, editTarget }: Props) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed right-0 top-0 z-50 flex h-full w-full max-w-[420px] flex-col bg-surface shadow-2xl transition-transform duration-300 ease-out ${
